...
class greengameHistory_desktop extends StatefulWidget {
  const greengameHistory_desktop({Key? key}) : super(key: key);

  @override
  State<greengameHistory_desktop> createState() => _greengameHistory_desktopState();
}

class _greengameHistory_desktopState extends State<greengameHistory_desktop> {
  @override
  void initState() {
    viewprofile();
    fetchData();
              ...
              Column(
                children: [
                  ...
                  Container(
                    ...
                    // FutureBuilder<List<timexhistory>>(
                    //   future: ert(),
