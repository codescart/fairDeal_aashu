...
class greengameHistory extends StatefulWidget {
  const greengameHistory({Key? key}) : super(key: key);

  @override
  State<greengameHistory> createState() => _greengameHistoryState();
}

class _greengameHistoryState extends State<greengameHistory> {
  @override
  void initState() {
    viewprofile();
    fetchData();
