...
import 'package:fairdeal/Desktop%20view/Desktop_HomeDirectry/green36_desktop/green36_home.dart';
...
import 'Desktop_HomeDirectry/Appbar.dart';




class home_page_desktop extends StatefulWidget {
  const home_page_desktop({Key? key}) : super(key: key);

  @override
  State<home_page_desktop> createState() => _home_page_desktopState();
}

class _home_page_desktopState extends State<home_page_desktop> {
          ...
          child: Row(
            ...
            children: [
              Column(
                ...
                children: [
                  Container(
                    padding: EdgeInsets.only(left: 100.h,bottom: 110.h),
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            ...
                            //   print("desktop view is running");
                            //   print("h "+ MediaQuery.of(context).size.height.toString());
                            //   print("w "+MediaQuery.of(context).size.toString());
                            //   setState(() {
                            ...
                            // }
                            Navigator.push(context,
                                MaterialPageRoute(builder: (contex)=>green36home_desktop()));
                          },
                          child: Container(
                        ...
                        InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (contex)=>Roulette_timex_home_desktop()));
