...
class gameHistory_blue_desktop extends StatefulWidget {
  const gameHistory_blue_desktop({Key? key}) : super(key: key);

  @override
  State<gameHistory_blue_desktop> createState() => _gameHistory_blue_desktopState();
}

class _gameHistory_blue_desktopState extends State<gameHistory_blue_desktop> {
  @override
  void initState() {
    viewprofile();
    super.initState();
