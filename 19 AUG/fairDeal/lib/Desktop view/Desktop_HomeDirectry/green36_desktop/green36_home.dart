...
import 'package:audioplayers/audioplayers.dart';
import 'package:fairdeal/Desktop%20view/Desktop_HomeDirectry/Roulette_timex_desktop/gameRule.dart';
import 'package:fairdeal/Desktop%20view/Desktop_HomeDirectry/green36_desktop/green_nibour.dart';
import 'package:fairdeal/Desktop%20view/Desktop_HomeDirectry/green36_desktop/greencasinoboard.dart';
import 'package:fairdeal/Desktop%20view/Desktop_HomeDirectry/green36_desktop/greengamehisotry.dart';
import 'package:fairdeal/Desktop%20view/Desktop_HomeDirectry/green36_desktop/greenspeenwheelnew.dart';
...
// // import 'package:fairdeal/HomeDirectry/green36/greengamehisotry.dart';
...
import '../../../HomeDirectry/home_page.dart';
import '../../../constant/Apihandler.dart';
import '../../../constant/chotaroletapi.dart';
import '../../../loginwigit/login_page.dart';
...
class green36home_desktop extends StatefulWidget {
  const green36home_desktop({Key? key}) : super(key: key);

  @override
  State<green36home_desktop> createState() => _green36home_desktopState();
  static void dispose() {}
}

class _green36home_desktopState extends State<green36home_desktop>with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    //   //   Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>green36home_desktop()));
    //   // }
    //
    //
    //   if(_clockModel.second<=50){
    //     if(_clockModel.second.isEven) {
    //       viewprofile();
    //       showcurrentbet();
    //     }
    //
...
bool watch= false;
                ...
                child: Stack(
                  children: [
                        ...
                        child: Container(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return Padding(
                                  padding:  EdgeInsets.only(left:widths/150),
                                  child: InkWell(
                                    onTap: () async{
                                      final prefs= await SharedPreferences.getInstance();
                    ...
                    Positioned(
                      ...
                      child: greenroulettelayout_desktop(
                        result:win,
                        ...
                        gnno: sno,
                          chuga:chuga,
                          time:time, timerclose: timerclosed,
                    ...
                    //       width:widths/10,
                    //       // heights>=340.00 && heights<=359.00? 150.h:
                    //       //               heights>=360.00 && heights<=375.00 ? 150.h
                    ...
                    //                 style: TextStyle(
                    //                     fontSize:widths/65,
                    //                     // heights>=340.00 && heights<=359.00? 20.sp:
                      ...
                      child: Container(
                        ...
                        child:Center(
                          ...
                          //       :heights>=550.00 && heights<=700.00?80.h:80.h,
                            ...
                            progressColor: cs==true?Colors.yellow:c==false?Colors.blue:Colors.blue,
                          ),
                        ),
                      ),
                    ):Container(),
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        width:widths/9,
                        // heights>=340.00 && heights<=359.00? 120.h:
                        //                 heights>=360.00 && heights<=375.00 ? 100.h
                            ...
                            children: [
                              ...
                              Center(
                                child: Text(maped==null?'':maped['wallet'],style: TextStyle(
                                    fontSize:widths/60,
                                    // heights>=340.00 && heights<=359.00? 16.sp:
                    ...
                    Positioned(
                      ...
                      //     :heights>=400.00 && heights<=480.00?140.h
                      //     :heights>=475.00 && heights<=500.00?140.h
                      //     :heights>=550.00 && heights<=700.00?180.h:180.h,
                      child: Container(
                        height:widths/23,
                        // heights>=340.00 && heights<=359.00?50.h:
                    ...
                    Positioned(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          width:widths/7,
                          // heights>=340.00 && heights<=359.00?220.h:
                          //               heights>=360.00 && heights<=375.00 ? 200.h
                          //     :heights<=400.00 && heights<=393.00?220.h
                          //     :heights>=400.00 && heights<=480.00?220.h
                          //     :heights>=475.00 && heights<=500.00?220.h
                          //     :heights>=550.00 && heights<=700.00?300.h:300.h,
                          decoration: BoxDecoration(
                              image: DecorationImage(
                          ...
                          child: Padding(
                            ...
                            child: Center(
                              child: Text('Bet Confirm',style: TextStyle(
                                  fontSize:widths/45,
                                  // heights>=340.00 && heights<=359.00? 28.sp:
                    ...
                    Positioned(
                      bottom: 0.h,
                      right: widths/8,
                      // heights>=340.00 && heights<=359.00? 130.h:
                      ...
                      child: InkWell(
                        onTap: (){
                          showDialog(
                            context: context,
                            builder: (BuildContext context) => greengameHistory_desktop(),
                          );
                        },
                        child: Container(
                          height:widths/20,
                            ...
                            children: [
                              ...
                              Center(
                                child: Text(
                                    ...
                                    style: TextStyle(
                                        fontSize:widths/60,
                                        // heights>=340.00 && heights<=359.00? 22.sp:
                                        // heights>=360.00 && heights<=375.00 ? 20.sp
                                        //     :heights<=400.00 && heights<=393.00?22.sp
                                        //     :heights>=400.00 && heights<=480.00?22.sp
                                        //     :heights>=475.00 && heights<=500.00?22.sp
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding:  EdgeInsets.only(right: 15.h,left: 15.h,top: 8.5.w),
                                          child: Row(
                                            children: [
                                        ...
                                        uwin==true?
                                        Padding(
                                          padding:  EdgeInsets.only(right: 15.0.w,left: 5.w, top: 5.w),
                                          child: Row(
                                            children: [
  ...
  clearbet() async{
    ...
    final response = await http.post(
      Uri.parse(
          "https://realdeal.games/admin/clearbet.php?gameseno=$sno&userid=$userid&gametype=1&gameno=2"),
  ...
  lockcheck() async{
    ...
    final res= await http.get(
        Uri.parse('https://realdeal.games/admin/checkstatus.php?userid=$userid'));
