...
class _CasinoState extends State<Casino> with SingleTickerProviderStateMixin{
  ...
  //   );
  //   // var
  //   var dat = jsonDecode(respo.body)['lastwinbetno'];
  //
  //
  //   setState(() {
  //     win =int.parse(dat.toString());
  //   });
  ...
  betconfirm() async{
    ...
    final response = await http.post(
      Uri.parse(
          "https://realdeal.games/admin/betlock.php?gameid=1&userid=$userid&gamesno=$gmno&gametype=1"),
    );
