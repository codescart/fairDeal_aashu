...
class RouletteLayout extends StatefulWidget {
  ...
  RouletteLayout({Key? key, required this.widths, required this.heights, required this.result, required this.gnno, required this.chuga, required this.time, required this.timerclose}) : super(key: key);
